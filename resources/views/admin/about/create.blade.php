                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('about.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Enter about title" class="form-control @error('title') is-invalid @else is-valid @enderror" name="title">
                                    @error('title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" rows="2" placeholder="Enter About Sort description" class="form-control @error('sort_desc') is-invalid @else is-valid @enderror" name="sort_desc"></textarea>
                                    @error('sort_desc')
                                        <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
